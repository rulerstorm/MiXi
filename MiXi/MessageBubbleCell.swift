...
func bubbleImageMake() -> (incoming: UIImage, incomingHighlighed: UIImage, outgoing: UIImage, outgoingHighlighed: UIImage) {
    let maskOutgoing = UIImage(named: "蜜喜蜜喜－切片iphone5_57")!
    let maskIncoming = UIImage(named: "蜜喜蜜喜－切片iphone5_58")!
    ...
    let incoming = maskIncoming.resizableImageWithCapInsets(capInsetsIncoming) //coloredImage(maskIncoming, 229/255.0, 229/255.0, 234/255.0, 1).resizableImageWithCapInsets(capInsetsIncoming)
    let incomingHighlighted = maskIncoming.resizableImageWithCapInsets(capInsetsIncoming) //coloredImage(maskIncoming, 206/255.0, 206/255.0, 210/255.0, 1).resizableImageWithCapInsets(capInsetsIncoming)
    let outgoing = maskOutgoing.resizableImageWithCapInsets(capInsetsOutgoing) //coloredImage(maskOutgoing, 43/255.0, 119/255.0, 250/255.0, 1).resizableImageWithCapInsets(capInsetsOutgoing)
    let outgoingHighlighted = maskOutgoing.resizableImageWithCapInsets(capInsetsOutgoing) //coloredImage(maskOutgoing, 32/255.0, 96/255.0, 200/255.0, 1).resizableImageWithCapInsets(capInsetsOutgoing)
